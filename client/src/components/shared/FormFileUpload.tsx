...
const FormFileUpload: React.FC<FileUploadProps> = ({
	...
	const renderUploadState = () => {
		...
		switch (status) {
			case 'initial':
				return (
					<div className="relative bg-gray-50 hover:bg-zinc-50">
						<input
							type="file"
							...
							id={id}
						/>
						<div className="border-2 border-dashed border-gray-300 rounded-lg p-5 hover:border-blue-400 hover:bg-blue-50 transition-colors">
							<div className="flex items-center justify-between">
								...
								<button className="px-8 py-3 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors font-inter hidden">
									Upload
								</button>
							</div>
						</div>
			...
			case 'uploading':
				return (
					<div className="border-2 border-dashed border-gray-300 rounded-lg p-5  transition-colors bg-white">
			...
			case 'too-large':
				return (
					<Fragment>
						<div
							className="border-2 border-dashed border-gray-300 rounded-lg p-5  transition-colors bg-white hover:bg-gray-50 cursor-pointer"
							onClick={handleRemove}
						>
							<div className="flex items-center justify-between">
								<div className="flex items-center space-x-3">
			...
			case 'error':
				return (
					<Fragment>
						<div className="border-2 border-dashed border-gray-300 rounded-lg p-5  transition-colors bg-white hover:bg-gray-50 cursor-pointer">
							<div className="flex items-center justify-between">
								<div className="flex items-center space-x-3">
